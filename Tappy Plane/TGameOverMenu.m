...
@interface TGameOverMenu()

@property (nonatomic) SKSpriteNode *medalDisplay;
@property (nonatomic) TBitmapFontLabel *scoreText;
@property (nonatomic) TBitmapFontLabel *bestScoreText;

@property (nonatomic) SKSpriteNode *gameOverTitle;
@property (nonatomic) SKNode *panelGroup;
@property (nonatomic) TButton *playButton;

@end

@implementation TGameOverMenu
...
-(instancetype)initWithSize:(CGSize)size {
    if (self = [super init]) {
        ...
        _scoreText = [[TBitmapFontLabel alloc] initWithText:@"0" andFontName:@"number"];
        ...
        _bestScoreText = [[TBitmapFontLabel alloc] initWithText:@"0" andFontName:@"number"];
        ...
        // Setup play button.
        _playButton = [TButton spriteNodeWithTexture:[atlas textureNamed:@"buttonPlay"]];
